...
export const getTiposTutoria = catchAsync(async (req, res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al obtener los tipos de tutoria", 500)
    }
});
...
export const getTipoTutoriabyId = catchAsync(async (req, res) => {
    try {
        ...
        if (result.length === 0) {
            throw AppError("Tipo de tutoria no encontrado", 404)
        }
        res.json(result[0])
    } catch (error) {
        console.log(error)
        throw AppError("Error al obtener el tipo de tutoria", 500)
    }
});
...
export const addTipoTutoria = catchAsync(async (req, res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al insertar el tipo de tutoria o dato duplicado", 500)
    }
});
...
export const updateTipoTutoria = catchAsync(async (req,res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al actualizar el tipo de tutoria", 500)
    }
});
...
export const deleteTipoTutoria = catchAsync(async (req, res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al eliminar el tipo de tutoria", 500)
    }
});