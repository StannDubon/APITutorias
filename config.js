...
export const JWT_SECRET = process.env.JWT_SECRET || 'CAMBIAR_EN_PRODUCCION'
export const JWT_REFRESH_SECRET = process.env.JWT_REFRESH_SECRET || 'CAMBIAR_EN_PRODUCCION_DIFERENTE'