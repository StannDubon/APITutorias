...
router.put("/PUThorarios/:id", verificarToken, verificarNivel(['admin']), validate(Horarios), updateHorario)

router.post("/POSThorarios", verificarToken, verificarNivel(['admin']), validate(Horarios), insertHorario)
