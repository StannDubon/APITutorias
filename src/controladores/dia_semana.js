...
export const get_dia_semana = catchAsync(async (req, res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al obtener los días de la semana", 500)
    }
}); 
...
export const get_dia_seamana_id = catchAsync(async (req, res) => {
    try {
        ...
        if (result.length === 0) {
            throw AppError("Dia de la semana no encontrado", 404)
        }
        res.json(result[0])
    } catch (error) {
        console.log(error)
        throw AppError("Error al obtener el dia de la semana", 500)
    }
});
//Update 
export const update_dia_semana = catchAsync(async (req, res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al actualizar el dia de la semana", 500)
    }
});
...
export const insert_dia_seamana = catchAsync(async (req, res) => {
    ...
    try {
        ...
        console.log(error)
        throw AppError("Error al insertar el Dia de la semana o Dia de la semana duplicado", 500)
    }
});
...
export const delete_dia_semana = catchAsync(async (req, res) => {
    try {
        ...
        console.log(error)
        throw AppError("Error al eliminar el Dia de la semana", 500)
    }
});
