...
export const updateHorarioDiaSemana = catchAsync(async (req, res) => {
    try {
        ...
        res.json({ message: "Horario de la semana actualizado exitosamente" })
    } catch (error) {
        console.log(error)
...
export const insertHorarioDiaSemana = catchAsync(async (req, res) => {
    try {
        ...
        res.status(201).json({ 
            message: "Horario de la semana creado exitosamente",
            data: result 
        })
    } catch (error) {
        console.log(error)
...
export const deleteHorarioDiaSemana = catchAsync(async (req, res) => {
    try {
        ...
        res.json({ message: "Horario de la semana eliminado exitosamente" })
    } catch (error) {
        console.log(error)
